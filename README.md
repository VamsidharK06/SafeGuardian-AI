SafeGuardian AI - Agentic Women Safety and Intelligent SOS Response Platform
Project Overview
...
PyTorch
Communication
Twilio / WhatsApp Business API (integration in progress)
Development & Testing
Visual Studio Code
Postman
Git
...
The remaining major task is configuring and validating automatic multi-contact emergency notification through a WhatsApp Business/Twilio provider.
